...
func GetDashBoard3Content(ctx *gin.Context) (types.Panel, error) {
	...
	ecbox := components.Box().WithHeadBorder().SetHeader("Query time compared to the hash table vs BST").SetBody(echart.SetContent(line).GetContent()).GetContent()
	...
	ecbox2 := components.Box().WithHeadBorder().SetHeader("Bar-Figure").SetBody(echart.SetContent(bar).GetContent()).GetContent()
	...
	ecbox3 := components.Box().WithHeadBorder().SetHeader("Bar3D-Figure").SetBody(echart.SetContent(bar3d).GetContent()).GetContent()
	...
	ecbox4 := components.Box().WithHeadBorder().SetHeader("BoxPlot-Figure").SetBody(echart.SetContent(bp).GetContent()).GetContent()
