...
func GetDashBoard3Content() (types.Panel, error) {
	...
	line.SetGlobalOptions(
		charts.YAxisOpts{Name: "search time(ns)", SplitLine: charts.SplitLineOpts{Show: false}},
		charts.XAxisOpts{Name: "element number"})
	line.Width = "250px"
	line.Height = "250px"

	ecbox := components.Box().WithHeadBorder(true).SetHeader("Query time compared to the hash table vs BST").SetBody(echart.SetContent(line).GetContent()).GetContent()

	bar := charts.NewBar()
	bar.SetGlobalOptions(
		charts.YAxisOpts{AxisLabel: charts.LabelTextOpts{Formatter: "{value} piece/day"}},
	)
	bar.AddXAxis(nameItems).
		AddYAxis("merchant A", randInt(), charts.BarOpts{YAxisIndex: 0}).
		AddYAxis("merchant B", randInt(), charts.BarOpts{YAxisIndex: 1})
	bar.ExtendYAxis(charts.YAxisOpts{AxisLabel: charts.LabelTextOpts{Formatter: "{value} piece/month"}})
	bar.Width = "250px"
	bar.Height = "250px"

	ecbox2 := components.Box().WithHeadBorder(true).SetHeader("Bar-Figure").SetBody(echart.SetContent(bar).GetContent()).GetContent()
	...
	ecbox3 := components.Box().WithHeadBorder(true).SetHeader("Bar3D-Figure").SetBody(echart.SetContent(bar3d).GetContent()).GetContent()
	...
	ecbox4 := components.Box().WithHeadBorder(true).SetHeader("BoxPlot-Figure").SetBody(echart.SetContent(bp).GetContent()).GetContent()
	...
	ecboxCol5 := colComp.SetSize(map[string]string{"md": "3"}).SetContent(components.Box().WithHeadBorder(true).
		SetHeader("EffectScatter-Figure").SetBody(echart.SetContent(es).GetContent()).GetContent()).GetContent()
	...
	ecboxCol6 := colComp.SetSize(map[string]string{"md": "3"}).SetContent(components.Box().WithHeadBorder(true).
		SetHeader("Funnel-Figure").SetBody(echart.SetContent(funnel).GetContent()).GetContent()).GetContent()
	...
	ecboxCol7 := colComp.SetSize(map[string]string{"md": "3"}).SetContent(components.Box().WithHeadBorder(true).
		SetHeader("Gauge-Figure").SetBody(echart.SetContent(gauge).GetContent()).GetContent()).GetContent()
	...
	ecboxCol8 := colComp.SetSize(map[string]string{"md": "3"}).SetContent(components.Box().WithHeadBorder(true).
		SetHeader("Geo-Figure").SetBody(echart.SetContent(geo).GetContent()).GetContent()).GetContent()
	...
	ecboxCol9 := colComp.SetSize(map[string]string{"md": "3"}).SetContent(components.Box().WithHeadBorder(true).
		SetHeader("Graph-Figure").SetBody(echart.SetContent(graph).GetContent()).GetContent()).GetContent()
	...
	ecboxCol10 := colComp.SetSize(map[string]string{"md": "3"}).SetContent(components.Box().WithHeadBorder(true).
		SetHeader("HeatMap-Figure").SetBody(echart.SetContent(hm).GetContent()).GetContent()).GetContent()
	...
	ecboxCol11 := colComp.SetSize(map[string]string{"md": "3"}).SetContent(components.Box().WithHeadBorder(true).
		SetHeader("Kline-Figure").SetBody(echart.SetContent(kline).GetContent()).GetContent()).GetContent()
	...
	ecboxCol12 := colComp.SetSize(map[string]string{"md": "3"}).SetContent(components.Box().WithHeadBorder(true).
		SetHeader("Line3D-Figure").SetBody(echart.SetContent(line3d).GetContent()).GetContent()).GetContent()
	...
	ecboxCol13 := colComp.SetSize(map[string]string{"md": "3"}).SetContent(components.Box().WithHeadBorder(true).
		SetHeader("Liquid-Figure").SetBody(echart.SetContent(liquid).GetContent()).GetContent()).GetContent()
	...
	ecboxCol14 := colComp.SetSize(map[string]string{"md": "3"}).SetContent(components.Box().WithHeadBorder(true).
		SetHeader("Map-Figure").SetBody(echart.SetContent(mc).GetContent()).GetContent()).GetContent()
	...
	ecboxCol15 := colComp.SetSize(map[string]string{"md": "3"}).SetContent(components.Box().WithHeadBorder(true).
		SetHeader("Pie-Figure").SetBody(echart.SetContent(pie).GetContent()).GetContent()).GetContent()
	...
	radar.Add("Beijing", radarDataBJ)
	radar.Width = "250px"
	radar.Height = "250px"

	ecboxCol16 := colComp.SetSize(map[string]string{"md": "3"}).SetContent(components.Box().WithHeadBorder(true).
		SetHeader("Radar-Figure").SetBody(echart.SetContent(radar).GetContent()).GetContent()).GetContent()
...
var (
	nameItems = []string{"t-shirt", "jeans", "slacks", "socks", "ski-wear,", "woolen"}
